...
namespace lucidcode.LightenedDream.Lucidity
{
	...
	partial class YearsListControl : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.Panel3D2.BackColor = MySettings1.FormBackColor;
			this.Panel3D2.Controls.Add(this.graph);
			this.Panel3D2.Controls.Add(this.lstDreams);
			this.Panel3D2.Controls.Add(this.Panel3D4);
			this.Panel3D2.DataBindings.Add(new System.Windows.Forms.Binding("BackColor", MySettings1, "FormBackColor", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
			...
			this.graph.Size = new System.Drawing.Size(634, 452);
			...
			this.lblTitle.Text = "Lucidity - Exercises";
