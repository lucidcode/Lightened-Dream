...
namespace lucidcode.LightenedDream.Dreams
{
	...
	partial class CompareDreamsControl : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CompareDreamsControl));
			...
			this.tmrDreams = new System.Windows.Forms.Timer(this.components);
			...
			this.lstDreams.Location = new System.Drawing.Point(54, 117);
			this.lstDreams.MultiSelect = false;
			this.lstDreams.Name = "lstDreams";
			this.lstDreams.Size = new System.Drawing.Size(527, 244);
			...
			this.lblTitle.Text = "Similar Dreams";
			...
			//mnuCategories
			//
			this.mnuCategories.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { this.mnuCopy });
			this.mnuCategories.Name = "mnuCategories";
			this.mnuCategories.Size = new System.Drawing.Size(161, 48);
			//
			//mnuCopy
			//
			...
			this.Name = "CompareDreamsControl";
		...
		private System.Windows.Forms.Timer withEventsField_tmrDreams;
		internal System.Windows.Forms.Timer tmrDreams {
			get { return withEventsField_tmrDreams; }
			set {
				if (withEventsField_tmrDreams != null) {
					withEventsField_tmrDreams.Tick -= tmrDreams_Tick;
				}
				withEventsField_tmrDreams = value;
				if (withEventsField_tmrDreams != null) {
					withEventsField_tmrDreams.Tick += tmrDreams_Tick;
				}
			}
		...
		private System.Windows.Forms.ToolStripMenuItem withEventsField_mnuCopy;
		internal System.Windows.Forms.ToolStripMenuItem mnuCopy {
			get { return withEventsField_mnuCopy; }
			set {
				if (withEventsField_mnuCopy != null) {
					withEventsField_mnuCopy.Click -= mnuCopy_Click;
				}
				withEventsField_mnuCopy = value;
				if (withEventsField_mnuCopy != null) {
					withEventsField_mnuCopy.Click += mnuCopy_Click;
				}
			}
